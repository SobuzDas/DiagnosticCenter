      ...
      <div class="row">
          <div class="col-md-3">
              <div class="second_tem">
                  <span id="imgcustom"><img src="{{ asset('web/images/img2.jpg') }}" height="200px" width="250px"></span>
                  <h4>CBC Test.</h4>
          ...
          <div class="col-md-3">
          <div class="second_tem">
                  <span id="imgcustom"><img src="{{ asset('web/images/img4.jpg') }}" height="200px" width="250px"></span>
                  ...
                  <span id="rdmore"><a href="content.html">Read More</a></span>
              </div>
          </div>
